...
<template>
  ...
  >
    <ComboboxButton
      ...
      class="h-10 relative flex w-full flex-wrap items-center gap-1 overflow-hidden rounded border-2 bg-white pr-14 text-sm focus-within:border-gray-200 focus-within:!bg-white hover:bg-gray-100 hover:border-gray-300 focus:ring-0 px-4"
    >
