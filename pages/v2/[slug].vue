  ...
  if (process.client) {
    if (!isFullscreen.value) {
      if (
        ...
        const iframe = document.querySelector('#game-full');
        // Do fullscreen
...
const { data: comments } = await useHttp(`game/${game.value.id}/comments`, {
  server: false,
  watch: [fetchComment],
});
</script>
        ...
        <div class="col-span-3 lg:col-span-2">
          <div class="comments mb-5">
            ...
            <div class="grid grid-cols-4 gap-5">
              <div class="col-span-4 md:col-span-1">
                ...
                <p class="text-[48px] text-center mb-4">4,5</p>
          ...
          <div class="tap-rate">
            ...
            <StarIcon
              v-for="index in 5"
              :key="index"
              class="w-8 h-8 fill-white stroke-[#F7A824] hover:fill-[#F7A824]"
              :class="{
                'fill-[#F7A824]': rating >= index,
              }"
