...
const isLogin = route.path.toLowerCase() === "/login";
</script>
        ...
        <div class="form__tablist">
          <div class="tablist-container">
            <div class="tablist-wrapper" role="tablist">
              <NuxtLink to="/login" class="tab tab-login" :class="{ 'tab--active': isLogin }">Login</NuxtLink>
              <NuxtLink to="/register" class="tab tab-register" :class="{ 'tab--active': !isLogin }">Register</NuxtLink>
            </div>
          </div>
        </div>
        <div
